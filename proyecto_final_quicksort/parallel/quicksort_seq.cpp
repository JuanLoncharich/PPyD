...
int main() {
    ...
    const std::string out_file = "results/sorted_players_seq.csv";
    list.save_csv(out_file);
    std::cout << "\nFull results saved to " << out_file << "\n";

    // Save timing to benchmark CSV
    ...
    bench << "1," << "0," << sort_time << "," << total_time << "\n";

    std::cout << "\nTiming saved to results/benchmark.csv\n";
